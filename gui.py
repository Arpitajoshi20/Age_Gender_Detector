...
#Defining Detect function wich detects the age and gender of the person in image using the model
...
def upload_image():
    try:
        ...
        uploaded.thumbnail(((tap.winfo_width()/2.25), (tup.winfo_height()/2.25)))
